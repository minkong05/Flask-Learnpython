// -----------------------------
// ChatGPT interaction logic class
// -----------------------------
(() => {
class Chat {
    constructor() {
    ...
    async sendMessage() {
        ...
        try {
            ...
            if (result.status === 'success') {
                // On success, display ChatGPT's response (supports HTML rendering)
            ...
            // Remove loading indicator and re-enable input box and button
            this.hideLoading();
...
// Initialize Chat instance after the page has fully loaded
